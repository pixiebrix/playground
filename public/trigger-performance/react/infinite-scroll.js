(() => {
  ...
  function InfiniteScroll({ params, ctl: ctl2 }) {
    const running = useDriver(ctl2);
    const [rows, setRows] = (0, import_react2.useState)([]);
    const seq = (0, import_react2.useRef)(0);
    const feedRef = (0, import_react2.useRef)(null);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "scroll-container", ref: feedRef, children: rows.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "feed-row", children: [
  ...
  PBX.page({
    ...
    selectors: [".feed-row"],
    tunables: [
      { key: "burst", label: "Rows per burst", def: 400, min: 1, max: 1e4 },
      { key: "interval", label: "Burst every (ms)", def: 250, min: 16, max: 5e3 },
      { key: "keep", label: "Max rows (0 = unbounded)", def: 4e3, min: 0, max: 2e5 }
    ],
    build(root, p) {
      (0, import_client.createRoot)(root).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(InfiniteScroll, { params: p, ctl }));
    },
    start() {
      ctl.start();
    },
