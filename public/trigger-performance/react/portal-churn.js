(() => {
  ...
  function PortalChurn({ params, ctl: ctl2 }) {
    const running = useDriver(ctl2);
    const [stage, setStage] = (0, import_react2.useState)(null);
    const [batch, setBatch] = (0, import_react2.useState)(0);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "stage", ref: setStage, children: "Portal subtrees mount / unmount here." }),
      stage && (0, import_react_dom.createPortal)(
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: Array.from({ length: params.size }, (_, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "portal-content", children: "." }, i)) }, batch),
        stage
      )
    ] });
  }
  ...
  PBX.page({
    ...
    tunables: [
      { key: "rate", label: "Mount/unmount cycles / sec", def: 200, min: 1, max: 6e3 },
      { key: "size", label: "Nodes per subtree", def: 50, min: 1, max: 2e3 }
    ],
    build(root, p) {
      (0, import_client.createRoot)(root).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PortalChurn, { params: p, ctl }));
    },
    start() {
      ctl.start();
    },
