(() => {
  ...
  function RenderStorm({ params, ctl: ctl2 }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rs-grid", children: items.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "storm-item" + (it.hot ? " hot" : ""), children: it.id }, it.id)) });
  }
  var ctl = makeCtl();
  PBX.page({
    ...
    tunables: [
      { key: "rate", label: "Re-renders / sec", def: 240, min: 1, max: 8e3 },
      { key: "nodes", label: "Item count", def: 3e3, min: 10, max: 6e4 },
      { key: "mode", label: "Churn mode", def: "remount", options: ["remount", "attr"] }
    ],
    build(root, p) {
      (0, import_client.createRoot)(root).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RenderStorm, { params: p, ctl }));
    },
    start() {
      ctl.start();
    },
