...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  function RouteView({ siblings }) {
    const { n = "0" } = useParams();
    const kids = [];
    for (let i = 0; i < siblings; i++) {
      kids.push(/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: i % 4 === 0 ? "pii" : "filler" }, i));
    }
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "route-active", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "route-status", children: [
        "route ",
        n,
        " \u2014 ",
        siblings,
        " nodes (",
        Math.ceil(siblings / 4),
        " .pii)"
      ] }),
      kids
    ] }, n);
  }
  function Driver({ params, ctl: ctl2 }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "rs-btn", onClick: swap, children: "\u25B8 Swap route now" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Routes, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, { path: "/", element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RouteView, { siblings: params.siblings }) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, { path: "/route/:n", element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RouteView, { siblings: params.siblings }) })
      ] })
    ] });
  }
  var ctl = makeCtl();
  PBX.page({
    ...
    tunables: [
      { key: "siblings", label: "Siblings per route", def: 800, min: 10, max: 2e4 },
      { key: "interval", label: "Auto-swap every (ms, 0=off)", def: 0, min: 0, max: 1e4 }
    ],
    build(root, p) {
      (0, import_client.createRoot)(root).render(
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HashRouter, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Driver, { params: p, ctl }) })
      );
    },
    start() {
      ctl.start();
